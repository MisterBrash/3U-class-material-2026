...
3. In your `index.html` you have a line that says "About Me". That should be a _hyperlink_ to your `about_me.html` page. Use the anchor tag and a _relative path_ to make this happen.

4. In your `about_me.html` you have a line that says "Back to Main Index". Make that a _hyperlink_ to your `index.html` file. Use a _relative path_ to make this happen.
...
<table style="width: 100%;">
  <tr>
    ...
    <td align="right"><a href="1.4 - Getting to Know Git.md">1.4 - Getting to Know Git</a></td>
  </tr>
</table>
