...
<table style="width: 100%;">
  <tr>
    <td align="left" valign="top"><a href="./1.4 - Headings Lists & Tables.md">1.4 - Headings Lists & Tables</a></td>
    <td align="center"><a href="./1.0 - README (ToC).md">Table of contents</a><br><br>(1.6 - Intro to CSS)</td>
    <td align="right" valign="top"><a href="./1.7 - Getting to Know Git.md">1.7 - Getting to Know Git</a></td>
  </tr>
</table>
