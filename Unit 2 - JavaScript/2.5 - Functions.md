...
🤔 How can we modify our code from `roll_d10()` to write `roll_d6()` and give us values 1-6 instead of 1-10?
...
<table style="width: 100%;">
  <tr>
    <td align="left" valign="top">⬅️ <a href="2.3 - Mathematics.md">2.3 - Mathematics</a></td>
    <td align="center"><a href="2.0 - Table of Contents.md">Table of contents</a><br><br>(2.5 - Functions)</td>
    <td align="right" valign="top"><a href="2.6 - Function Parameters.md">2.6 - Function Parameters</a> ➡️</td>
  </tr>
</table>